...
def main():
    ...
    Usage:\n\
        ncs_stats.py -i qc_report_file -o output_html_file \n\n\
    Example:\n\
        ncs_stats.py -i Holland_Release_Set_10_QC_Report.xlsx -o ncs_stats.html\n'
    ...
    global log 
    log = open('ncs_stats' + '.log', 'a')
    log.write('\n' + str(datetime.datetime.now()) + '\n')
    log.write(' '.join(sys.argv) + '\n')
    log.write('ncs_stats.py version ' + __version__ + '\n\n')
    log.flush()
    ...
    #
    ######################################
    send_update("\nncs_stats.py successfully completed", log)
