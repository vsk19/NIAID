...
def create_tracking(sentDF, receivedDF, familyDF, filename):
    ...
    seq_family_members = seq_family_members.loc[~seq_family_members['CIDR_Exome_ID'].str.contains('Cancel', case=False, na=True)]
    ...
    #seq_family_members.dropna(subset=['CIDR_Exome_ID'], inplace=True)
    seq_family_members = seq_family_members.loc[seq_family_members.CIDR_Exome_ID.notnull()]
